...
const Pricing = () => {
  ...
  const packages = [
    {
      ...
      month: 19,
      yearlyPrice: 199,
      green: "/src/assets/hinhtron.png",
      description:
        "A common form Lorem ipsum reads: Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    },
    {
      name: "Advance",
      month: 39,
  ...
  return (
    <>
      <div className="md:px-14 max-w-s mx-auto py-10" id="Pricing">
        <div className="text-center">
          <h2 className="md:text-5xl text-3xl font-extrabold text-primary mb-2">
            Here are all our plans
          </h2>
          <p className="text-primary md:w-1/3 mx-auto px-4">
        ...
        >
          {packages.map((pkg, index) => (
            ...
            >
              ...
              <p className="1mt-5 text-center text-secondary text-4xl font-bold">
                {isYearly ? `$${pkg.yearlyPrice}` : `$${pkg.month}`}
