    ...
    <>
      <div className="bg-[#010851] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
        <div className="my-12 flex flex-col md:flex-row gap-10">
          <div className="md:w-1/2 space-y-8">
            ...
            >
              ...
              <span className="text-white">TranThe</span>
            </a>
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:items-center justify-between my-8">
          <p>@ Design website by Tran The</p>
          <div className="flex items-center space-x-5">
            <FaFacebook className="w-8 cursor-pointer hover:-translate-y-4 transition-all duration-300" />
            <FaInstagramSquare className="w-8 cursor-pointer hover:-translate-y-4 transition-all duration-300" />
